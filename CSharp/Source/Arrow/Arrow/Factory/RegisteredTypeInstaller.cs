...
namespace Arrow.Factory
{
	...
	public static class RegisteredTypeInstaller
	{
		...
		private static Dictionary<Assembly,bool> s_AssembliesProcessed=new Dictionary<Assembly,bool>();
		
		private static Dictionary<Type,MethodInfo> s_FactoryRegister=new Dictionary<Type,MethodInfo>();
